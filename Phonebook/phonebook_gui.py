...
def load_gui(self):
    '''
    Function that defines the default tkinter widgets and their initial
    configuration and place place via grid()
    '''
    ...
    #use rowspan and columnspan for widgets that cross more than one cell
        #value is number of rows/columns they span, default is 1
    ...
    #listbox with scrollbar
        #use bind to listen for event (ListboxSelect) and execute function
        #lambda event = anonymous function
